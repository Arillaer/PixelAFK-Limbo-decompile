...
public class TitleUtils {
    ...
    public static void playFakeLightning(Player player, boolean bl) {
        ...
        PacketPlayOutSpawnEntityWeather packetPlayOutSpawnEntityWeather = new PacketPlayOutSpawnEntityWeather(new EntityLightning(worldServer, player.getLocation().getX(), player.getLocation().getY(), player.getLocation().getZ()));
